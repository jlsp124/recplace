...
## Password gates (deterrent only)

- Plans page: `plans.html` → password `RecPlacePro2740`
- Admin page: `admin.html` → password `Pahal123`

Static “passwords” on GitHub Pages can be bypassed; use real hosting/auth if you need true protection.
